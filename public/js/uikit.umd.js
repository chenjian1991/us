(function (global, factory) {
  ...
  function () {
    ...
    _createClass(DepthChart, [{
      ...
      //   let opts = {dataset: data}
      //   if(!(opts.dataset instanceof Dataset))
      //     opts.dataset = new ArrayDataset(opts.dataset,opts.theme.scalable)
      //   this.opts.dataset = opts.dataset
      //   render()
      // }
      ...
      value: function update(data) {
        ...
        if (!(this.opts.dataset instanceof Dataset)) this.opts.dataset = new ArrayDataset(this.opts.dataset, this.opts.theme.scalable);
        this.render();
      }
    }, {
      key: "render",
