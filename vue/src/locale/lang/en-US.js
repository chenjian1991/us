export default {
  ...
  homealldaydes: "Liquidity premium through 24/7 asset exposure on a global platform",
  ...
  aboutInfo1: "55 Global Markets is the world's first asset trading platform designed to allow a seamless and efficient flow of high-quality assets around the world. 55 Global Markets aims to build a globally connected, continuous, transparent, low-friction, non-discriminatory asset trading network using blockchain technology and tokens as transaction vehicles. 55 Global Markets and its sub-markets support trading of a variety of assets including DPL (Distributed Public Ledger) token,DAPP token,tokenized stock,forex,precious metals, real estate, premium brand products, and local business and personal tokens.",
  ...
  aboutInfo4: ' 55 Global Markets is officially registered as a Money Service Business (MSB) with U.S. regulators, administered by the Financial Crimes Enforcement Network (FinCEN). This registration means that 55 can perform crypto-to-crypto trading in most U.S. states and territories. The MSB No. is 31000137604928 ',
