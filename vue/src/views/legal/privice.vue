<template>
    <div class="aboutBox">
        ...
        <div class="row terms">
			...
			<p >
				9.1 If you have any requests and comments, you can send an email to support@55.com, which is the only valid and official email through which we communicate with you, so we will not bear any liability for your failure to using effective contact information, any act or omission.
			</p>
			<p >
