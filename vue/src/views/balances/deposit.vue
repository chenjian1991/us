               ...
               if (res.length !== 0) {
                  res.map((v) => {
                     if (v["currency"] === this.currency) {
                        ...
                        this.depositData['available'] = this.transferNumber(v.available, precision)
                        this.depositData['frozen'] = this.transferNumber(v.frozen, precision)
                        this.depositData['total'] = this.transferNumber(bigDecimal.add(v.available, v.frozen), precision)
