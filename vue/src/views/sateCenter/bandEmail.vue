    ...
    <div  id="bandemail" class="root">
        <div  class="wrapper">
            <div  class="register_wraper">
                   <div class="band-nav">
                        <router-link to='/safeCenter'>{{$t('aqzxSafeCeneter')}} </router-link>><router-link to='/bandingPhone'> {{$t('aqzxBandEmail')}}</router-link>
                    </div>
                    <div class="tips">
                           {{$t('aqzxTips')}}
                    </div>
                            ...
                            <div class="phone-item">
                             ...
                             <div v-if="googleFlag">
                                    ...
                                    <FormItem class="form_item" prop='googleCode'>
                                        <Input type="password" v-model="formValidate.googleCode" :placeholder="$t('goolePlaceholder')"></Input>
                                    </FormItem>
                             </div>
