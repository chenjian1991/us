export default {
   ...
   HomeSignin: 'เข้าสู่ระบบ',
   HomeSignup: 'สมัครใช้งาน',
   homeOrder: 'คำสั่งซื้อ',
   homeBalances: 'สินทรัพย์',
   tbdhTransactionHistory: 'Transaction History',
   tbdhAccountSecurity: 'Account & Security',
   tbdhIDVerification: 'การรับรองข้อมูลประจำตัว',
   invitePeople: 'หมายเลขคำเชิญพิเศษ',
   tbdhLogout: 'ออกจากระบบ',
   headerhome: "Home",
   ...
   // 注册登录
   phonePlacehodlerphone: 'โปรดป้อนหมายเลขโทรศัพท์',
   emailPlacehodler: "โปรดป้อนอีเมลล์",
   emialCodePlaceholder: "รหัสตรวจสอบของอีเมลล์",
   SMSPlacehodler: 'รหัสการตรวจสอบด้วยข้อความ',
   passwordPlacehodler: 'Password',
   confirmPasswordPlacehodler: 'ยืนยันรหัสผ่าน',
   referridPlacehodler: 'รหัสเชิญ（เลือกกรอก）',
   ...
   checkboxRequire: 'ปรดทำเครื่องหมายถูกต้องตรงข้อตกลงผู้ใช้',
   passwordNotMach: 'รหัสผ่านไม่ตรงกัน โปรดยืนยันอีกครั้ง',
   passwordReg: 'รหัสผ่านต้องมี 8-20 หลักและต้องไม่เป็นตัวเลขหมด',
   regAgree: 'I agree to 55',
   regTermsOfUse: 'User Agreement',
   dlWelcome: 'Welcome to 55',
   dlLogin: 'เข้าสู่ระบบ',
   dlForgot: 'ลืมรหัสผ่าน?',
   dlSignup: 'Sign Up',
   siginAcountPlaceholder: 'Email / Phone number',
   signPasswordPlaceholder: 'Please enter password',
   signupPhone: 'สมัครด้วยหมายเลขโทรศัพท์',
   signupEmail: 'สมัครด้วยอีเมล์',
   regPhone: 'สมัครด้วยหมายเลขโทรศัพท์',
   regSend: 'Send',
   ...
   //忘记密码翻译
   zhmmResetPassword: "รีเซ็ตรหัสผ่านเข้าสู่ระบบ",
   zhmmResetPasswordTitle: "Password Reset - 55",
   zhmmResetExplain: "หลังจากตั้งค่ารหัสผ่านใหม่ภายใน 24 ชั่วโมงจะไม่สามารถเบิกเงินเหรียญได้",
   zhmmInputAccount: "Please enter the email or phone number used for registration",
   zhmmResetSubmit: "ส่ง",
   zhmmSecurity: "การตรวจสอบความปลอดภัย",
   zhmmSecurityExplain: "หลังจากตั้งค่ารหัสผ่านใหม่ภายใน 24 ชั่วโมงจะไม่สามารถเบิกเงินเหรียญได้",
   zhmmSend: "Send",
   zhmmSecuritySubmit: "ส่ง",
   zhmmSetNewPassword: "Set  new password",
   zhmmInputNewPassword: "รหัสผ่านเข้าสู่ระบบใหม่",
   zhmmConfirmPassword: "ยืนยันรหัสผ่านเข้าสู่ระบบใหม่",
   zhmmSetSubmit: "ส่ง",
   ...
   bbjyBuyTitle: 'ซื้อ',
   bbjyBuyAvailable: 'ที่ใช้ได้',
   bbjyBuyPrice: 'ราคา',
   bbjyStop: 'Suspended trading',
   bbjyBuyAmount: 'จํานวน',
   bbjyBuyTotal: 'Total',
   bbjyBuyLoginRegister: 'เข้าสู่ระบบ หรือ สมัคร',
   bbjyBuyLogin: 'เข้าสู่ระบบ',
   bbjyBuyRegister: 'สมัคร',
   bbjyBuyOperation: 'ซื้อ',
   bbjySellTitle: 'ขาย',
   bbjySellAvailable: 'ที่ใช้ได้',
   bbjySellPrice: 'ราคา',
   bbjySellAmount: 'จํานวน',
   bbjySellTotal: 'Total',
   bbjySellLoginRegister: 'Login or Register to trade',
   bbjySellLogin: 'เข้าสู่ระบบ',
   bbjySellRegister: 'สมัคร',
   bbjySellOperation: 'ขาย',
   bbjyNowPrice: 'ราคา',
   bbjyNowAmount: 'จํานวน',
   bbjyNowTotal: 'Total',
   bbjyMore: 'More',
   bbjyOpenOrders: 'คำสั่งซื้อในปัจจุบัน',
   bbjyOrderBuy: 'ซื้อ',
   bbjyOrderSell: 'ขาย',
   bbjyOrderAll: 'All',
   bbjyOrderDate: 'เวลา',
   bbjyOrderPair: 'การซื้อขายต่อ',
   bbjyOrderType: 'Type',
   bbjyOrderSide: 'ทิศทาง',
   bbjyOrderPrice: 'ราคา',
   bbjyOrderAmount: 'ปริมาณ',
   bbjyOrderFilled: 'มีการซื้อขายแล้ว',
   bbjyOrderTotal: 'จำนวนเงินรวมที่สั่งซื้อ',
   bbjyOrderTIP: 'ยังไม่มีประวัติ',
   bbjyHistory: 'บัญชีรายการ',
   bbjyHideOther: 'Hide Other Pair',
   bbjyHistoryDate: 'เวลา',
   bbjyHistoryPair: 'การซื้อขายต่อ',
   bbjyHistoryType: 'Type',
   bbjyHistorySide: 'ทิศทาง',
   bbjyHistoryAvg: 'Avg',
   bbjyHistoryPrice: 'ราคา',
   bbjyHistoryFilled: 'มีการซื้อขายแล้ว',
   bbjyHistoryAmount: 'ปริมาณ',
   bbjyHistoryTIP: 'ยังไม่มีประวัติ',
  ...
  10014: "Incorrect account or login password, please try again. ", //代表用户不存在
   ...
   aqzxset: 'ผูกไว้',
   aqzxsee:"View",
   aqzxclose: 'ปิดการตรวจสอบ',
   aqzxModify: 'แก้ไข',
   aqzxPhoneNumber: 'โทรศัพท์มือถือ',
   aqzxEmailAdders: 'อีเมลล์',
   aqzxGoogle: 'ตัวตรวจสอบกูเกิ้ล',
   aqzxIdentity: 'L1 Verification',
   aqzxPhoneExplain: "ใช้ในการตรวจสอบความปลอดภัยเวลาถอนเงินเหรียญ กู้คืนรหัสผ่าน แก้ไขการตั้งค่าการรักษาความปลอดภัย และการจัดการ API.",
 ...
 sfrzIDExplainone: "In order to secure the funds of your account, please register your real name authentication information.",
   ...
   sfrzIDApproved: "ข้อมูลประจำตัวของคุณได้ผ่านการรับรองแล้ว",
   sfrzNationality: "สัญชาติ：",
   sfrzIDNo: "หมายเลขบัตรประจำตัว：",
   ...
   footercompany: "Company",
   footerabout55: "About",
   footersecretterms: "นโยบายความเป็นส่วนตัว",
   footerlaw: 'ประกาศทางกฎหมาย',
   footerfees: "อัตราค่าใช้จ่าย",
   ...
   zcOperation: 'ปฏิบัติการ',
   zcDeposit: 'ติมเงิน',
   zcWithdrawal: 'เบิกเงินสด',
   zcTrade: 'การซื้อขาย',
   ...
   BalancesDate: 'เวลา',
   BalancesCoin: 'สกุลเงิน',
   BalancesAmount: 'จํานวน',
   ...
   BalancesHide: 'สินทรัพย์รวมเท่ากับ',
   ...
   //充值
   czBalances: 'สินทรัพย์',
   czDeposit: 'เติมเงิน',
   czWhat: 'What is',
   czTotalBalance: 'Total Balance',
   czInOrder: 'อายัด',
   czAvailableBalance: 'ที่ใช้ได้',
   czDepositAddress: 'ที่อยู่เติมเงินเหรีญ',
   czShowQRCode: 'QR โค้ด',
   czCopyAddress: 'คัดลอก',
   ...
   depositAddress: 'ที่อยู่เติมเงินเหรีญ',
   depositNext: 'Continue Deposit',
   depositCopy: 'Copy MEMO',

   // 提现页
   tsBalances: 'สินทรัพย์',
   tsWithdrawal: 'เบิกเงินสด',
   tsWhat: 'What is',
   tsTotalBalance: 'Total Balance',
   tsInOrder: 'อายัด',
   tsAvailableBalance: 'ที่ใช้ได้',
   tsWithdrawalAddress: 'ที่อยู่ในการเบิก',
   ...
   tsAvailable: 'ที่ใช้ได้',
   tsNoAvailable: 'จำนวนที่จะเบิกเกินกว่าจำนวนเงินที่ใช้ได้.',
   tsTransactionFee: 'ค่าธรรมเนียม',
   tsReceiveAmount: 'จำนวนที่เข้าบัญชี',
   tsSubmit: 'Submit',
   ...
   tsMoreThan: 'จำนวนที่จะเบิกเกินกว่าจำนวนเงินที่ใช้ได้',
