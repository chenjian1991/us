export default {
   ...
   tbdhAccountSecurity: 'Hesap Güvenliği',
   tbdhIDVerification: 'Kimlik doğrulama',
   invitePeople: 'Exclusive invitation code',
   tbdhLogout: 'Çık',
   headerhome: "Home",
   ...
   // 注册登录
   phonePlacehodlerphone: 'Lütfen telefon numaranızı girin',
   emailPlacehodler: "lütfen e-postanızı giriniz",
   emialCodePlaceholder: "E-posta doğrulama kodu",
   SMSPlacehodler: 'SMS doğrulama kodu',
   passwordPlacehodler: 'Password',
   confirmPasswordPlacehodler: 'Şifreyi Onayla',
   referridPlacehodler: 'Invitation code (optional)',
   ...
   checkboxRequire: 'tfen kullanıcı sözleşmesini işaretleyin',
   passwordNotMach: 'Şifre aynı değil, lütfen tekrar teyit ediniz',
   passwordReg: 'Parola 8-20 basamaklı olmalı, sadece sayı olamaz',
   regAgree: 'I agree to 55',
   regTermsOfUse: 'User Agreement',
   dlWelcome: 'Welcome to 55',
   dlLogin: 'Giriş Yap',
   dlForgot: 'şifremi unuttum?',
   dlSignup: 'Sign Up',
   siginAcountPlaceholder: 'Email / Phone number',
   signPasswordPlaceholder: 'Please enter password',
   signupPhone: 'Telefonunuzla kaydolun',
   signupEmail: 'E-posta ile kayıt ol',
   regPhone: 'Telefonunuzla kaydolun',
   regSend: 'Send',
   regSignup: 'Kayıt',
   ...
   //忘记密码翻译
   zhmmResetPassword: "Giriş şifresini sıfırla",
   zhmmResetPasswordTitle: "Password Reset - 55",
   zhmmResetExplain: "Şifresi sıfırlandıktan sonraki 24 saat içinde nakit çekmek yasaklanır.",
   zhmmInputAccount: "Please enter the email or phone number used for registration",
   zhmmResetSubmit: "Gönder",
   zhmmSecurity: "Güvenlik doğrulaması",
   zhmmSecurityExplain: "Şifresi sıfırlandıktan sonraki 24 saat içinde nakit çekmek yasaklanır.",
   zhmmSend: "Send",
   zhmmSecuritySubmit: "Gönder",
   zhmmSetNewPassword: "Set  new password",
   zhmmInputNewPassword: "Yeni giriş şifresi",
   zhmmConfirmPassword: "Yeni şifreyi onayla",
   zhmmSetSubmit: "Gönder",
   ...
   bbjyChooseType: 'Type',
   bbjyChoosePrice: 'Fiyat',
   bbjyChange: 'Change',
   bbjyHourHigh: 'Yüksek',
   bbjyHourLow: 'Düşük',
   bbjyHourVol: '24 Saatlik Hacim',
   bbjyNormal: 'Normal',
   bbjyProfessional: 'Professional',
   bbjyBuyTitle: 'Satın al',
   bbjyBuyAvailable: 'Kullanılabilir',
   bbjyBuyPrice: 'Fiyat',
   bbjyStop: 'Suspended trading',
   bbjyBuyAmount: 'Miktar',
   bbjyBuyTotal: 'İşlem tutarı',
   bbjyBuyLoginRegister: 'Giriş Yap Ya Da Kayıtol',
   bbjyBuyLogin: 'Giriş Yap',
   bbjyBuyRegister: 'Kayıtol',
   bbjyBuyOperation: 'Satın al',
   bbjySellTitle: 'Sat',
   bbjySellAvailable: 'Kullanılabilir',
   bbjySellPrice: 'Fiyat',
   bbjySellAmount: 'Miktar',
   bbjySellTotal: 'İşlem tutarı',
   bbjySellLoginRegister: 'Giriş Yap Ya Da Kayıtol',
   bbjySellLogin: 'Giriş Yap',
   bbjySellRegister: 'Kayıtol',
   bbjySellOperation: 'Sat',
   bbjyNowPrice: 'Fiyat',
   bbjyNowAmount: 'Miktar',
   bbjyNowTotal: 'İşlem tutarı',
   bbjyMore: 'Daha Fazla',
   bbjyOpenOrders: 'AçıkTeklifler',
   bbjyOrderBuy: 'Satın al',
   bbjyOrderSell: 'Sat',
   bbjyOrderAll: 'Daha Fazla',
   bbjyOrderDate: 'Zaman',
   bbjyOrderPair: 'İşlem',
   bbjyOrderType: 'Type',
   bbjyOrderSide: 'Yön',
   bbjyOrderPrice: 'Fiyat',
   bbjyOrderAmount: 'Miktar',
   bbjyOrderFilled: 'Satıldı',
   bbjyOrderTotal: 'Total',
   bbjyOrderTIP: 'Kayıt yok',
   bbjyHistory: 'Order History',
   bbjyHideOther: 'Hide Other Pair',
   bbjyHistoryDate: 'Zaman',
   bbjyHistoryPair: 'İşlem',
   bbjyHistoryType: 'Type',
   bbjyHistorySide: 'Yön',
   bbjyHistoryAvg: 'Average Price',
   bbjyHistoryPrice: 'Fiyat',
   bbjyHistoryFilled: 'Satıldı',
   bbjyHistoryAmount: 'Miktar',
   bbjyHistoryTIP: 'Kayıt yok',
   bbjyTradeHistory: 'İşlem Geçmişi',
  ...
  10014: "Incorrect account or login password, please try again. ", //代表用户不存在
   ...
   aqzxclose: 'Turn off',
   aqzxModify: 'Değiştir',
   aqzxPhoneNumber: 'Cep telefonu',
   aqzxEmailAdders: 'Posta kutusu',
   aqzxGoogle: 'Google Validator',
 ...
 sfrzIDExplainone: "In order to secure the funds of your account, please register your real name authentication information.",
   ...
   sfrzIDApproved: "Kimlik bilgileriniz sertifikalandırılmıştır",
   sfrzNationality: "País：",
   sfrzIDNo: "Kimlik numarası：",
   ...
   footercompany: "Company",
   footerabout55: "About",
   footersecretterms: "Gizlilik Politikası",
   footerlaw: 'Yasal Uyarılar',
   footerfees: "Ücret",
   ...
   orderOpen: 'Şu anda görevlendirilmiş',
   orderComplete: 'Emanet geçmişi',
   orderDetail: 'İşlem geçmişi',
   orderSideAll: "Side",
   orderSearch: "Search",
   orderReset: "Reset",
   ...
   BalancesDate: 'Zaman',
   BalancesCoin: 'Para birimi',
   BalancesAmount: 'Miktar',
   ...
   czDeposit: 'Yatır',
   czWhat: 'What is',
   czTotalBalance: 'Toplam bakiye',
   czInOrder: 'Dondur',
   czAvailableBalance: 'Kullanılabilir',
   czDepositAddress: 'Yatırım adresi',
   czShowQRCode: 'Show QR Code',
   czCopyAddress: 'Kopyala',
   ...
   tsWithdrawal: 'Çek',
   tsWhat: 'What is',
   tsTotalBalance: 'Toplam bakiye',
   tsInOrder: 'Dondur',
   tsAvailableBalance: 'Kullanılabilir',
   tsWithdrawalAddress: 'Nakit çekme adresi',
   tsUseNewAddress: 'Yeni adres kullan',
   tsInput: 'Please input your new withdrawal address below',
   tsAmount: 'Miktar',
   tsWithdrawalLimit: '24h Withdrawal Limit',
   tsAvailable: 'Kullanılabilir',
   tsNoAvailable: 'Para Çekme Miktarı Mevcut Tutarı Aşıyor.',
   tsTransactionFee: 'Ücret',
   tsReceiveAmount: 'Hesaba yatan',
   tsSubmit: 'Gönder',
   tsHowWithdrawal: 'How to Withdrawal?',
   tsTips: 'İpuçları',
   tsMinimum: 'Minimum para çekme',
   ...
   tsMoreThan: 'Para Çekme Miktarı Mevcut Tutarı Aşıyor.',
   ...
   txUseNewAddress: 'Yeni adres kullan',
