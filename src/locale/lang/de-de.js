export default {
   ...
   HomeSignup: 'Registrieren',
   HomeSignin: 'Anmelden',
   homeOrder: 'Aufträge',
   homeBalances: 'Guthaben',
   tbdhTransactionHistory: 'Transaction History',
   tbdhAccountSecurity: 'Konto & Sicherheit',
   tbdhIDVerification: 'L1 Verifikation',
   invitePeople: 'Exklusiver Einladungscode',
   tbdhLogout: 'Abmelden',
   headerhome: "Home",
   ...
   // 注册登录
   phonePlacehodlerphone: 'Bitte geben E-Mail-Adresse oder Handynummer ein.',
   emailPlacehodler: "E-mail eingeben",
   emialCodePlaceholder: "Email-Code",
   SMSPlacehodler: 'SMS-Freischaltcode',
   passwordPlacehodler: 'Passwort mit 8-20 Zeichen eingeben, und pure Nummern sind ungültig',
   confirmPasswordPlacehodler: 'Passwort wiederholen',
   referridPlacehodler: 'Einladungscode (Wenn Sie haben)',
   ...
   checkboxRequire: 'Bitte kreuzen Sie an',
   passwordNotMach: 'Passworte sind nicht identisch, bitte geben Sie erneut ein',
   passwordReg: 'Passwort mit 8-20 Zeichen eingeben, und pure Nummern sind ungültig',
   regAgree: 'I agree to 55',
   regTermsOfUse: 'User Agreement',
   dlWelcome: 'Welcome to 55',
   dlLogin: 'Anmelden',
   dlForgot: 'Passwort vergessen?',
   dlSignup: 'Sign Up',
   siginAcountPlaceholder: 'Email / Phone number',
   signPasswordPlaceholder: 'Bitte geben Passwort ein',
   signupPhone: 'mit Handy',
   signupEmail: 'mit E-Mail',
   regPhone: 'mit Handy',
   regSend: 'Send',
   ...
   //忘记密码翻译
   zhmmResetPassword: "Passwort ändern",
   zhmmResetPasswordTitle: "Password Reset - 55",
   zhmmResetExplain: "Nach der Passwort-Änderung wird die Abhebung innerhalb von 24 Stunden unzulässig.",
   zhmmInputAccount: "Please enter the email or phone number used for registration",
   zhmmResetSubmit: "Vorlegen",
   ...
   bbjyBuyTitle: 'Kaufen',
   bbjyBuyAvailable: 'Verfügbar',
   bbjyBuyPrice: 'Preis',
   bbjyStop: 'Suspended trading',
   bbjyBuyAmount: 'Betrag',
   bbjyBuyTotal: 'Volumen',
   bbjyBuyLoginRegister: "Anmelden Oder Registrieren",
   bbjyBuyLogin: 'Anmelden',
   bbjyBuyRegister: 'Registrieren',
   bbjyBuyOperation: 'Kaufen',
   bbjySellTitle: 'Verkaufen',
   bbjySellAvailable: 'Verfügbar',
   bbjySellPrice: 'Preis',
   bbjySellAmount: 'Betrag',
   bbjySellTotal: 'Volumen',
   bbjySellLoginRegister: 'Anmelden Oder Registrieren',
   bbjySellLogin: 'Anmelden',
   bbjySellRegister: 'Registrieren',
   bbjySellOperation: 'Verkaufen',
   bbjyNowPrice: 'Preis',
   bbjyNowAmount: 'Betrag',
   bbjyNowTotal: 'Volumen',
   bbjyMore: 'More',
   bbjyOpenOrders: 'Offene Aufträge',
   bbjyOrderBuy: 'Kaufen',
   bbjyOrderSell: 'Verkaufen',
   bbjyOrderAll: 'More',
   bbjyOrderDate: 'Stand',
   bbjyOrderPair: 'Paar',
   bbjyOrderType: 'Type',
   bbjyOrderSide: 'Typ',
   bbjyOrderPrice: 'Preis',
   bbjyOrderAmount: 'Betrag',
   bbjyOrderFilled: 'Erfolgreich',
   bbjyOrderTotal: 'Volumen',
   bbjyOrderTIP: 'Keine Auflistung',
   bbjyHistory: 'Order History',
   bbjyHideOther: 'Hide Other Pair',
   bbjyHistoryDate: 'Stand',
   bbjyHistoryPair: 'Paar',
   bbjyHistoryType: 'Type',
   bbjyHistorySide: 'Typ',
   bbjyHistoryAvg: 'Durchschnittspreis',
   bbjyHistoryPrice: 'Preis',
   bbjyHistoryFilled: 'Erfolgreich',
   bbjyHistoryAmount: 'Menge',
   bbjyHistoryTIP: 'Keine Auflistung',
   bbjyTradeHistory: 'Transaktionshistorie',
   ...
   aqzxset: 'Verbinden',
   aqzxsee: "View",
   aqzxclose: 'Abschalten',
   aqzxModify: 'Ändern',
   aqzxPhoneNumber: 'Handy',
   aqzxEmailAdders: 'E-Mail',
   ...
   // sfrzIDCardFrontLabel11: "Please upload the front side of your driver's license, ID card, or passport.",
   ...
   sfrzIDApproved: "Ihre Identität ist verifiziert.",
   ...
   footercompany: "Company",
   footerabout55: "About",
   footersecretterms: "Datenschutzerklärung",
   footerlaw: 'Rechtliche Hinweise',
   footerfees: "Gebührensatz",
   ...
   BalancesDate: 'Stand',
   BalancesCoin: 'Währung',
   BalancesAmount: 'Betrag',
   ...
   BalancesHide: 'Kleine Salden hide',
   ...
   czDeposit: 'Einzahlen',
   czWhat: 'What is',
   czTotalBalance: 'Account Saldo',
   czInOrder: 'Sperren',
   czAvailableBalance: 'Verfügbar',
   czDepositAddress: 'Einzahlungsadresse',
   czShowQRCode: 'Show QR Code',
   czCopyAddress: 'Kopieren',
   ...
   // 提现页
   tsBalances: 'Guthaben',
   tsWithdrawal: 'Abheben',
   tsWhat: 'What is',
   tsTotalBalance: 'Account Saldo',
   tsInOrder: 'Sperren',
   tsAvailableBalance: 'Verfügbar',
   tsWithdrawalAddress: 'Adresse',
   tsUseNewAddress: 'Benutzen Sie eine neue Adresse / neue Adresse benutzen',
   ...
   tsTransactionFee: 'Gebühren',
   tsReceiveAmount: 'Ankunftsmenge',
   tsSubmit: 'Senden',
   ...
   txUseNewAddress: 'Benutzen Sie eine neue Adresse / neue Adresse benutzen',
...
//   api
   ...
   kyc2Notic2: "* please verify that all your information is accurate before submiiting",
   kyc2Basic: "Basic",
   kyc2Address: "Address",
   kyc2Tax: "Tax",
