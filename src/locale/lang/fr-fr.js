export default {
   ...
   HomeSignup: "S'enregistrer",
   homeOrder: 'Commande',
   homeBalances: 'Actifs',
   tbdhTransactionHistory: 'Transaction History',
   tbdhAccountSecurity: 'Compte & Sécurité',
   tbdhIDVerification: 'L1 Verification',
   invitePeople: "Code d'invitation exclusif",
   tbdhLogout: 'Quitter',
   headerhome: "Home",
   ...
   // 注册登录
   phonePlacehodlerphone: 'Veuillez entrer votre émail et numéro de téléphone',
   emailPlacehodler: "Veuillez entrer l'adresse émail",
   emialCodePlaceholder: "Code de confirmation émail",
   SMSPlacehodler: 'Code de vérification SMS',
   passwordPlacehodler: 'Le mot de passe doit être 8-20 chiffres, ne peut pas être le nombre pur',
   confirmPasswordPlacehodler: 'Confirmer le mot de Passe',
   referridPlacehodler: 'Code d‘invitation (Si vous avez）',
   ...
   checkboxRequire: "uillez cocher la condition d'utilisateur",
   passwordNotMach: 'Les deux mots de passes sont différents. Veuillez réessayer.',
   passwordReg: 'Le mot de passe doit être 8-20 chiffres, ne peut pas être le nombre pur',
   regAgree: 'I agree to 55',
   regTermsOfUse: 'User Agreement',
   dlWelcome: 'Welcome to 55',
   dlLogin: "S'identifier",
   dlForgot: 'Mot de Passe Oublié?',
   dlSignup: 'Sign Up',
   siginAcountPlaceholder: 'Email / Phone number',
   signPasswordPlaceholder: 'Veuillez entrer le mot de passe',
   signupPhone: 'Enregistrement mobile',
   signupEmail: 'Enregistrement par émail',
   regPhone: 'Enregistrement mobile',
   regSend: 'Send',
   regSignup: "S'enregistrer",
   ...
   //忘记密码翻译
   zhmmResetPassword: "Réinitialiser mot de passe",
   zhmmResetPasswordTitle: "Password Reset - 55",
   zhmmResetExplain: "Le retrait sera désactivé en 24H une fois le mot de passe remis à zéro.",
   zhmmInputAccount: "Please enter the email or phone number used for registration",
   zhmmResetSubmit: "Soumis",
   zhmmSecurity: "Authentification de sécurité",
   zhmmSecurityExplain: "Le retrait sera désactivé en 24H une fois le mot de passe remis à zéro.",
   zhmmSend: "Send",
   zhmmSecuritySubmit: "Soumis",
   zhmmSetNewPassword: "Set  new password",
   zhmmInputNewPassword: "Nouveau mot de passe",
   zhmmConfirmPassword: "Confirmez le nouveau mot de passe",
   zhmmSetSubmit: "Soumis",
   ...
   bbjyBuyTitle: 'Acheter',
   bbjyBuyAvailable: 'Disponible',
   bbjyBuyPrice: 'Prix',
   bbjyStop: 'Suspended trading',
   bbjyBuyAmount: 'Montant',
   bbjyBuyTotal: 'Total',
   bbjyBuyLoginRegister: "S'identifier Ou S'inscrire",
   bbjyBuyLogin: "S'identifier",
   bbjyBuyRegister: "S'inscrire",
   bbjyBuyOperation: 'Acheter',
   bbjySellTitle: 'Vendre',
   bbjySellAvailable: 'Disponible',
   bbjySellPrice: 'Prix',
   bbjySellAmount: 'Montant',
   bbjySellTotal: 'Total',
   bbjySellLoginRegister: "S'identifier Ou S'inscrire",
   bbjySellLogin: "S'identifier",
   bbjySellRegister: "S'inscrire",
   bbjySellOperation: 'Vendre',
   bbjyNowPrice: 'Prix',
   bbjyNowAmount: 'Montant',
   bbjyNowTotal: 'Total',
   bbjyMore: 'Plus',
   bbjyOpenOrders: 'Ordres ouverts',
   bbjyOrderBuy: 'Acheter',
   bbjyOrderSell: 'Vendre',
   bbjyOrderAll: 'Plus',
   bbjyOrderDate: 'Date',
   bbjyOrderPair: 'Paires',
   bbjyOrderType: 'Type',
   bbjyOrderSide: 'Côté',
   bbjyOrderPrice: 'Prix',
   bbjyOrderAmount: 'Montant',
   bbjyOrderFilled: 'exécuté',
   bbjyOrderTotal: 'Total',
   bbjyOrderTIP: 'Aucun enregistrement',
   bbjyHistory: 'Historique des commandes',
   bbjyHideOther: 'Hide Other Pair',
   bbjyHistoryDate: 'Date',
   bbjyHistoryPair: 'Paires',
   bbjyHistoryType: 'Type',
   bbjyHistorySide: 'Côté',
   bbjyHistoryAvg: 'Prix Moyen',
   bbjyHistoryPrice: 'Prix',
   bbjyHistoryFilled: 'exécuté',
   bbjyHistoryAmount: 'Montant',
   bbjyHistoryTIP: 'Aucun enregistrement',
  ...
  10014: "Incorrect account or login password, please try again. ", //代表用户不存在
   ...
   aqzxclose: 'Éteindre',
   aqzxModify: 'Changer',
   aqzxPhoneNumber: 'Téléphone',
   aqzxEmailAdders: 'Email',
   aqzxGoogle: 'Google authentificateur',
  ...
  // 谷歌验证
   ...
   aqzxCloseGooglePassword: "Mot de passe:",
   ggyzMAcountSecurity: "Acount & Security >",
   ggyzMGoogleAuthentication: "Activer l'Authentification Google",
   ...
   ggyzEnableGoogle: "4.Activer l'Authentification Google",
  ...
  ggyzIOSMethod: 'Search “Google Authenticator” on the app store to download on iOS.',
   ...
   ggyzLoginPassword: "Mot de passe:",
   ...
   ggyzEnableGA: "Activer l'Authentification Google",
 ...
 sfrzIDExplainone: "In order to secure the funds of your account, please register your real name authentication information.",
   ...
   sfrzIDApproved: "Votre vérification d'identité a été approuvée",
   sfrzNationality: "Staatsangehörigkeit：",
   sfrzIDNo: "Numéro d'identification.：",
   ...
   footermore: "More",
   UserAgreement: "Conditions d'Utilisateur",
   ...
   footercompany: "Company",
   footerabout55: "About",
   footersecretterms: "Politique de Confidentialité",
   footerlaw: 'Déclaration Légal',
   footerfees: "Taxes",
   ...
   zcType: 'Devise',
   zcBalance: 'Disponible',
   zcInOrders: 'Sur les Commandes',
   zcTotal: 'Total',
   zcUSDTEstimation: 'USDD Estimation',
   zcOperation: 'Operation',
   zcDeposit: 'Dépôt',
   zcWithdrawal: 'Retirement',
   zcTrade: 'échange',
   ...
   BalancesHide: 'Masquer petits soldes',
   ...
   czDeposit: 'Dépôt',
   czWhat: 'What is',
   czTotalBalance: 'Solde Total',
   czInOrder: 'Sur les Commandes',
   czAvailableBalance: 'Disponible',
   czDepositAddress: 'Adresse de dépôt',
   czShowQRCode: 'Show QR Code',
   czCopyAddress: 'Copier',
   ...
   // 提现页
   tsBalances: 'Actifs',
   tsWithdrawal: 'Retirement',
   tsWhat: 'What is',
   tsTotalBalance: 'Solde Total',
   tsInOrder: 'Sur les Commandes',
   tsAvailableBalance: 'Disponible',
   tsWithdrawalAddress: 'Dirección de retiro',
   tsUseNewAddress: 'Utiliser une nouvelle adresse',
   tsInput: 'Please input your new withdrawal address below',
   tsAmount: 'Montant',
   tsWithdrawalLimit: '24h Withdrawal Limit',
   tsAvailable: 'Disponible',
   tsNoAvailable: 'Montant de retirement dépasse montant disponible',
   tsTransactionFee: 'Frais',
   tsReceiveAmount: 'Le nombre de comptes',
   tsSubmit: 'Envoyer',
   ...
   tsMoreThan: 'Montant de retirement dépasse montant disponible',
   ...
   txUseNewAddress: 'Utiliser une nouvelle adresse',
