export default {
   ...
   HomeSignup: 'Registrarme',
   HomeSignin: 'Iniciar sesión',
   homeOrder: 'Pedidos',
   homeBalances: 'Saldos',
   tbdhTransactionHistory: 'Transaction History',
   tbdhAccountSecurity: 'Cuenta & Seguridad',
   tbdhIDVerification: 'L1 Verificación',
   invitePeople: 'Código exclusivo',
   tbdhLogout: 'Cerrar sesión',
   headerhome: "Home",
   ...
   // 注册登录
   phonePlacehodlerphone: 'Ingrese su email o móvil',
   emailPlacehodler: "Por favor ingresa el email",
   emialCodePlaceholder: "Código de verificación email",
   SMSPlacehodler: 'Código de confirmación SMS',
   passwordPlacehodler: 'La contraseña debe contener 8-20 caracteres. No pueden ser números puros',
   confirmPasswordPlacehodler: 'Confirmar Contraseña',
   referridPlacehodler: 'Código de invitación(Opcional, No obligatorio)',
   ...
   checkboxRequire: 'Haga clic',
   passwordNotMach: 'Las dos contraseñas son diferentes. Por favor intentarlo otra vez',
   passwordReg: 'La contraseña debe contener 8-20 caracteres. No pueden ser números puros',
   regAgree: 'I agree to 55',
   regTermsOfUse: 'User Agreement',
   dlWelcome: 'Welcome to 55',
   dlLogin: 'Iniciar sesión',
   dlForgot: '¿Ha olvidado su contraseña?',
   dlSignup: 'Sign Up',
   siginAcountPlaceholder: 'Email / Phone number',
   signPasswordPlaceholder: 'Por favor ingrese la contraseña',
   ...
   //忘记密码翻译
   zhmmResetPassword: "Modificar contraseña",
   zhmmResetPasswordTitle: "Password Reset - 55",
   zhmmResetExplain: "El retiro se desactivará en 24H una vez que se restablezca la contraseña.",
   zhmmInputAccount: "Please enter the email or phone number used for registration",
   zhmmResetSubmit: "enviar",
   zhmmSecurity: "Verificación de seguridad",
   zhmmSecurityExplain: "El retiro se desactivará en 24H una vez que se restablezca la contraseña.",
   zhmmSend: "Send",
   zhmmSecuritySubmit: "enviar",
   zhmmSetNewPassword: "Set  new password",
   zhmmInputNewPassword: "Contraseña nueva",
   zhmmConfirmPassword: "Confirmar la contraseña nueva",
   ...
   bbjyChooseType: 'Método',
   bbjyChoosePrice: 'Precio',
   bbjyChange: 'Cambio',
   bbjyHourHigh: 'Alto',
   bbjyHourLow: 'Bajo',
   ...
   bbjyBuyAmount: 'Cantidad',
   bbjyBuyTotal: 'Total',
   bbjyBuyLoginRegister: 'Iniciar Sesión O Registrarme',
   bbjyBuyLogin: 'Iniciar',
   bbjyBuyRegister: 'Registrarme',
   bbjyBuyOperation: 'Comprar',
   bbjySellTitle: 'Vender',
   bbjySellAvailable: 'Disponible',
   bbjySellPrice: 'Precio',
   bbjySellAmount: 'Cantidad',
   bbjySellTotal: 'Total',
   bbjySellLoginRegister: 'Iniciar Sesión O Registrarme',
   bbjySellLogin: 'Iniciar',
   bbjySellRegister: 'Registrarme',
   bbjySellOperation: 'Vender',
   bbjyNowPrice: 'Precio',
   bbjyNowAmount: 'Cantidad',
   bbjyNowTotal: 'Total',
   bbjyMore: 'Más',
   bbjyOpenOrders: 'Ordenes abiertas',
   bbjyOrderBuy: 'Comprar',
   bbjyOrderSell: 'Vender',
   bbjyOrderAll: 'Más',
   bbjyOrderDate: 'Fecha',
   bbjyOrderPair: 'Pares',
   bbjyOrderType: 'Método',
   bbjyOrderSide: 'Tipo',
   bbjyOrderPrice: 'Precio',
   bbjyOrderAmount: 'Cantidad',
   bbjyOrderFilled: 'Ejecutado',
   bbjyOrderTotal: 'Total',
   bbjyOrderTIP: 'No Récords',
   bbjyHistory: 'Order History',
   bbjyHideOther: 'Hide Other Pair',
   bbjyHistoryDate: 'Fecha',
   bbjyHistoryPair: 'Pares',
   bbjyHistoryType: 'Método',
   bbjyHistorySide: 'Tipo',
   bbjyHistoryAvg: 'Precio medio',
   bbjyHistoryPrice: 'Precio',
   bbjyHistoryFilled: 'Ejecutado',
   bbjyHistoryAmount: 'Cantidad',
   bbjyHistoryTIP: 'No Récords',
  ...
  10014: "Incorrect account or login password, please try again. ", //代表用户不存在
   ...
   aqzxsee:"View",
   aqzxclose: 'Cerrar',
   aqzxModify: 'Modificar',
   aqzxPhoneNumber: 'Móvil',
   ...
   aqzxCloseGoogletitle: "Activar la autenticación de Google",
   aqzxCloseGooglePassword: "Contraseña de acceso:",
   ggyzMAcountSecurity: "Acount & Security >",
   ggyzMGoogleAuthentication: "Activar la autenticación de Google",
   ...
   ggyzEnableGoogle: "4.Activar la autenticación de Google",
  ...
  ggyzIOSMethod: 'Search “Google Authenticator” on the app store to download on iOS.',
   ...
   ggyzLoginPassword: "Contraseña de acceso：",
   ggyzGoogleAuthenticationCode: "Código de verificación Google:",
   ggyzEnterYourGA: "Enter the 6-digit verification code in your GA.",
   ggyzPrevStep3: "Prev Step",
   ggyzEnableGA: "Activar la autenticación de Google",
 ...
 sfrzIDExplainone: "In order to secure the funds of your account, please register your real name authentication information.",
   ...
   sfrzIDApproved: "Su verificación de ID ha sido aprobada",
   sfrzNationality: "Nationalité：",
   ...
   footercompany: "Company",
   footerabout55: "About",
   footersecretterms: "Política de Privacidad",
   footerlaw: 'Declaración legal',
   footerfees: "Tasa",
   ...
   orderOpen: 'Pedidos actuales',
   orderComplete: 'Mis pedidos',
   orderDetail: 'Mis transacciones',
   orderSideAll: "Side",
   orderSearch: "Search",
   orderReset: "Reset",
   ...
   zcInOrders: 'Pendiente',
   zcTotal: 'Total',
   zcUSDTEstimation: 'USDD Estimation',
   zcOperation: 'Acciones',
   zcDeposit: 'Depositar',
   zcWithdrawal: 'Retirar',
   zcTrade: 'Exchange',
   ...
   czDeposit: 'Depositar',
   czWhat: 'What is',
   czTotalBalance: 'Saldo disponible',
   czInOrder: 'Pendiente',
   czAvailableBalance: 'Disponible',
   czDepositAddress: 'Dirección de Depósito',
   ...
   // 提现页
   tsBalances: 'Saldos',
   tsWithdrawal: 'Retirar',
   tsWhat: 'What is',
   tsTotalBalance: 'Saldo disponible',
   tsInOrder: 'Pendiente',
   tsAvailableBalance: 'Disponible',
   tsWithdrawalAddress: 'Dirección de retiro',
   tsUseNewAddress: 'Usar dirección nueva',
   tsInput: 'Please input your new withdrawal address below',
   tsAmount: 'Cantidad',
   tsWithdrawalLimit: '24h Withdrawal Limit',
   tsAvailable: 'Disponible',
   tsNoAvailable: 'Cantidad de retiro se excede en la cantidad disponible.',
   tsTransactionFee: 'Comisión',
   tsReceiveAmount: 'Cantidad recibida',
   tsSubmit: 'Enviar',
   tsHowWithdrawal: 'How to Withdrawal?',
   tsTips: 'Tips',
   tsMinimum: 'Retiro mínimo',
   ...
   tsMoreThan: 'Cantidad de retiro se excede en la cantidad disponible',
   ...
   txUseNewAddress: 'Usar dirección nueva',
