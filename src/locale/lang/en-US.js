export default {
   ...
   zhmmSecurityExplain: "For security purposes, no withdrawals are permitted for 24 hours following any changes to your account security, including password resets.",
   zhmmSend: "Send",
   ...
   aqzxtips: "*For security purposes, no withdrawals are permitted for 24 hours following any changes to your account security, including password resets.",
   ...
   aqzxtradepasswordtips: "*For security purposes, no withdrawals are permitted for 24 hours following any changes to your account security, including password resets.",
   ...
   // sfrzIDCardBackLabel11: "Please upload the back side of your driver's license or ID card or passport.",
   ...
   usddWhyHoldReason: "tresso support wide range of tokenized assets to be exchanged with USDD",
   ...
   kyc2Resultsub: "Thank you for submitting you KYC information.",
   kyc2Resultsub1: "We will review your submission and inform you about your approval status within",
   kyc2Resultsub2: "business days.",
   kyc2Resultsub3: "Return",
   kyc2Resultbutton: "If you have any questions, please email us at contact-us@tresso.com.",
   ...
   supemail: "6. All rights are reserved by 55.com. If you have any questions, please contact: service@tresso.com.",
   supclose: "Close",
   supcopy: "Copy",
...
//   kyc
   ...
   inviteRebateRecord: "Commission Record",
   inviteRebateRatio: "Commission Proportion",
   inviteRule1: "No one who is an US or Canada user can participate, If user referred US or Canada user, they won't get the reward directly or indirectly.",
   inviteRule2: "The inviter needs to complete KYC verification first.",
   inviteRule3: "Only when invitee uses inviter’s referral link, QR code or referral code on registration page to register will commission be rewarded to the inviter. Commission is 50% of the transaction fee.",
   inviteRule4: "The commission will be calculated based on corresponding proportion of the actual transaction fee for each transaction completed by invitees.",
   inviteRule5: "Commission will be transferred to the inviter’s account in the type of token the invitee trade with.",
   inviteRule6: "Only invitees invited after the campaign starting at 08:00 (UTC+8) on June 1st, 2019 are qualified for the referral program. There is no limitation on the number of invitees.",
   inviteRule7: "The commission will be calculated on the day and transferred to the account the next day; Commission= actual transaction fee *commission rate.",
   inviteRule8: "Commission of referral program is only valid within 365 days. 365 days after your friend’s registration, you will not be entitled to the commission of the inviting transaction.",
   inviteRule9: "Settlement: 10:00 (UTC+8).",
   inviteRule10: "55.com strictly checks for duplicate or false accounts. Once the account is found to be in violation of the corresponding risk control rules, the commission will not be issued.",
   inviteRule11: "55 Asset Network reserves the final interpretation of adjustments to the commission rules due to possible unpredictable changes in market environment and fraud risks. Theses rules subject to change without notice.",
   invitePartner1: "Global Partner Recruitment Plan",
   invitePartner2: "Become Global Partner, enjoy up to 50% primary commission and 20% secondary commission",
   inviteSlogan1: "0 lockup 0 threshold",
   inviteSlogan2: "50% high commission rate ",
   inviteSlogan3: "Invite a friend to get a commission",
   inviteTotal1: " Total primary invitations",
   inviteRebate1: "Primary commission rate",
   inviteTotal2: "Total secondary invitations",
   inviteRebate2: "Secondary commission rate",
   inviteRebateAddition: "FF commission bonus",
   invitePartnerRule1: "Primary Invitation Commission: Only when invitee uses inviter’s referral link, QR code or referral code on registration page to register will commission be rewarded to the inviter. Primary invitation commission is 50% of the service fee.",
   invitePartnerRule2: "Secondary Invitation Commission: If new invitee uses primary invitee’s referral link, QR code or referral code on registration page to register, commission will still be rewarded to the inviter.  Secondary commission rate is 20% of the service fee.",
   invitePartnerRule3: "Commission will be rewarded based on actual service fee generated from each transaction at a certain commission rate.",
   invitePartnerRule4: "Token: Commission will be transferred to the inviter’s account in the type of token the invitee trade with.",
   invitePartnerRule5: "Only invitees invited after the campaign starting at 08:00(UTC+8) on June 1st, 2019 are qualified for the referral program. There is no limitation on the number of invitees.",
   invitePartnerRule6: "Referral commission is calculated on the day and transferred to the account the next day. Commission= Actual service fee * commission rate",
   invitePartnerRule7: "Global Partner will only receive referral commission within 365 days since the invitee’s registration.",
   invitePartnerRule8: "Global Partnership will be assessed based on actual commission status. If the partner doesn’t meet a certain number of successful referrals required the current month, the Partnership will be invalid the following month.",
   invitePartnerRule9: "Commission Settlement: settle commission generated on the day at 10:00 (UTC+8) each day.",
   invitePartnerRule10: "55 strictly checks for duplicate or false accounts. Once the account is found to be in violation of the corresponding risk control rules, the commission will not be issued.",
   invitePartnerRule11: "55 Asset Network reserves the final interpretation of adjustments to the commission rules due to possible unpredictable changes in market environment and fraud risks.",
   inviteRecordFirstLevel: "Primary Invitation Record",
   inviteRecord: "Invitation Record",
   applyList: 'Apply to List',
   inviteNotAllowed: "You cannot use this feature in accordance with local laws and regulations",
   inviteBack: "Back to Home",
   inviteNotKyc: "ID verification is required",
   inviteToKyc: "ID Verification",
};