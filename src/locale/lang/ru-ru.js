export default {
   ...
   HomeSignin: 'ВОЙТИ',
   HomeSignup: 'РЕГИСТРАЦИЯ',
   homeOrder: 'ОРДЕРА',
   homeBalances: 'БАЛАНС',
   tbdhTransactionHistory: 'Transaction History',
   tbdhAccountSecurity: 'Аккаунт & Безопасность',
   tbdhIDVerification: 'Верификация，L1 Verifikation',
   invitePeople: 'Свой код приглашения，Exklusiver Einladungscode',
   tbdhLogout: 'ВЫЙТИ',
   headerhome: "Home",
   ...
   // 注册登录
   phonePlacehodlerphone: 'Введите Email адрес или номер телефона',
   emailPlacehodler: "Введите Email адрес",
   emialCodePlaceholder: "Код подтверждения с Email",
   SMSPlacehodler: 'Код с телефона',
   passwordPlacehodler: 'Пароль должен быть длиной 8-20 символов, и содержать как минимум 1 цифру и 1 букву.',
   confirmPasswordPlacehodler: 'Подтвердите пароль',
   referridPlacehodler: 'Код приглашения (только если у вас есть)',
   ...
   checkboxRequire: 'Установите флажок',
   passwordNotMach: 'Пароли не совпадают. Пожалуйста, повторите попытку.',
   passwordReg: 'Пароль должен быть длиной 8-20 символов, и содержать как минимум 1 цифру и 1 букву.',
   regAgree: 'I agree to 55',
   regTermsOfUse: 'User Agreement',
   dlWelcome: 'Welcome to 55',
   dlLogin: 'Войти',
   dlForgot: 'Забыли пароль?',
   dlSignup: 'Sign Up',
   siginAcountPlaceholder: 'Email / Phone number',
   signPasswordPlaceholder: 'Введите пароль',
   signupPhone: 'Телефон',
   signupEmail: 'Email',
   regPhone: 'Телефон',
   regSend: 'Send',
   regSignup: 'Регистрация',
   ...
   //忘记密码翻译
   zhmmResetPassword: "Изменить пароль",
   zhmmResetPasswordTitle: "Password Reset - 55",
   zhmmResetExplain: "Средства невозможно вывести в течение 24 часов после изменения пароля.",
   zhmmInputAccount: "Please enter the email or phone number used for registration",
   zhmmResetSubmit: "Представить",
   zhmmSecurity: "Аутентификация Безопасности",
   zhmmSecurityExplain: "Средства невозможно вывести в течение 24 часов после изменения пароля.",
   zhmmSend: "Send",
   zhmmSecuritySubmit: "Представить",
   zhmmSetNewPassword: "Set  new password",
   zhmmInputNewPassword: "Новый пароль",
   zhmmConfirmPassword: "Подтвердите новый пароль",
   zhmmSetSubmit: "Представить",
   ...
   bbjyChooseType: 'Метод',
   bbjyChoosePrice: 'Цена',
   bbjyChange: 'Изм',
   bbjyHourHigh: 'Высокий',
   bbjyHourLow: 'Низкий',
   bbjyHourVol: '24ч Объём',
   bbjyNormal: 'Normal',
   bbjyProfessional: 'Professional',
   bbjyBuyTitle: 'Купить',
   bbjyBuyAvailable: 'Доступные',
   bbjyBuyPrice: 'Цена',
   bbjyStop: 'Suspended trading',
   bbjyBuyAmount: 'Кол.',
   bbjyBuyTotal: 'Всего',
   bbjyBuyLoginRegister: 'Войти Или Регистрация，Anmelden Oder Registrieren',
   bbjyBuyLogin: 'Войти',
   bbjyBuyRegister: 'Регистрация',
   bbjyBuyOperation: 'Купить',
   bbjySellTitle: 'Продать',
   bbjySellAvailable: 'Доступные',
   bbjySellPrice: 'Цена',
   bbjySellAmount: 'Кол.',
   bbjySellTotal: 'Всего',
   bbjySellLoginRegister: 'Войти Или Регистрация，Anmelden Oder Registrieren',
   bbjySellLogin: 'Войти',
   bbjySellRegister: 'Регистрация',
   bbjySellOperation: 'Продать',
   bbjyNowPrice: 'Цена',
   bbjyNowAmount: 'Кол.',
   bbjyNowTotal: 'Всего',
   bbjyMore: 'Больше',
   bbjyOpenOrders: 'Открытые ордера',
   bbjyOrderBuy: 'Купить',
   bbjyOrderSell: 'Продать',
   bbjyOrderAll: 'Больше',
   bbjyOrderDate: 'Дата',
   bbjyOrderPair: 'Пара',
   bbjyOrderType: 'Метод',
   bbjyOrderSide: 'Направление',
   bbjyOrderPrice: 'Цена',
   bbjyOrderAmount: 'Объём',
   bbjyOrderFilled: 'Исполнено',
   bbjyOrderTotal: 'Сумма',
   bbjyOrderTIP: 'Нет истории',
   bbjyHistory: 'История ордеров',
   bbjyHideOther: 'Hide Other Pair',
   bbjyHistoryDate: 'Дата',
   bbjyHistoryPair: 'Пара',
   bbjyHistoryType: 'Метод',
   bbjyHistorySide: 'Направление',
   bbjyHistoryAvg: 'Средняя цена',
   bbjyHistoryPrice: 'Цена',
   bbjyHistoryFilled: 'Исполнено',
   bbjyHistoryAmount: 'Объём',
   bbjyHistoryTIP: 'Нет истории',
   bbjyTradeHistory: 'История торгов',
   ...
   bbjyTipSubmit: 'Представлене',
   bbjyTipCancel: 'Cancel',
   bbjyTips: 'ТЁПЛАЯ ПОДСКАЗКА',
  ...
  10014: "Incorrect account or login password, please try again. ", //代表用户不存在
   ...
   aqzxclose: 'Выключить',
   aqzxModify: 'Изменить',
   aqzxPhoneNumber: 'Номер телефона',
   aqzxEmailAdders: 'Электронная почта',
   aqzxGoogle: 'Google authenticator',
   aqzxIdentity: 'L1 Verification',
   aqzxPhoneExplain: "Для вывода, восстановления пароля, изменения настройки безопасности и управления API.",
 ...
 // 谷歌验证
   ...
   ggyzDownloadApp: "1.Скачать приложение",
   ggyzScanQRCode: "2. Сканировать QR-код",
   ggyzBackupKey: "3. Резервный ключ",
   ggyzEnableGoogle: "4.Enable Google Authentication",
   ggyzDownloadAndInstall: "Скачать и установить приложение Google для аутентификации",
   ggyzAndroid: "Android",
  ggyzIOSMethod: 'Search “Google Authenticator” on the app store to download on iOS.',
   ...
   ggyzHaveInstalled: "Я установил приложение",
   ggyzNextStep1: "Следующий шаг",
   ggyzUseAPPScan: "Use Google Authenticator APP to scan this QR code",
   ggyzManuallyAPP: 'Если вы не можете сканировать QR-код, пожалуйста, введите код вручную в приложении.',
   ggyzProvidedKey: "Provided key",
   ggyzPrevStep1: "Предыдущий шаг",
   ggyzHaveScannedQRcode: "I have scanned the QR code",
   ggyzNextStep2: "Следующий шаг",
 ...
 sfrzIDExplainone: "In order to secure the funds of your account, please register your real name authentication information.",
   ...
   sfrzIDApproved: "Успешная верификация：",
   sfrzNationality: "Гражданство",
   sfrzIDNo: "Номер удостоверения личности：",
   ...
   yqzyWaySharing: "Мой способ поделиться",
   yqzyCodePoster: "Своя афиша из QR-кода",
   yqzyChoosePoster: "Выбрать свою афишу из QR-кода",
   yqzyExclusiveCode: "Свой код приглашения",
   yqzyCopyCode: "Copy code",
   yqzyRegistrationLink: "Своя ссылка для регистрации",
   ...
   footercompany: "Company",
   footerabout55: "About",
   footersecretterms: "Положения о конфиденциальности",
   footerlaw: 'Юридическое заявление',
   footerfees: "Комиссии",
   ...
   orderOpen: 'Открытые ордера',
   orderComplete: 'История ордеров',
   orderDetail: 'История сделок',
   orderSideAll: "Side",
   orderSearch: "Search",
   orderReset: "Reset",
   ...
   zcType: 'Валюта',
   zcBalance: 'Доступные',
   zcInOrders: 'Замороженные',
   zcTotal: 'Total',
   zcUSDTEstimation: 'USDD Estimation',
   zcOperation: 'Действие',
   zcDeposit: 'Депозит',
   zcWithdrawal: 'Вывести',
   zcTrade: 'Торги',
   ...
   czDeposit: 'Депозит',
   czWhat: 'What is',
   czTotalBalance: 'Общий баланс',
   czInOrder: 'Замороженные',
   czAvailableBalance: 'Доступные',
   czDepositAddress: 'Депозит адрес',
   czShowQRCode: 'Показать QR-код',
   czCopyAddress: 'Скопировать',
   czHowDeposit: 'How to Deposit to 55?',
   czTips: 'ТЁПЛАЯ ПОДСКАЗКА',
   sendOnly: ' Send only',
   ...
   copySuccess: ' success',
   depositNotice: 'ТЁПЛАЯ ПОДСКАЗКА:',
   ...
   depositAddress: 'Депозит адрес',
   depositNext: 'Continue Deposit',
   depositCopy: 'Copy MEMO',

   // 提现页
   tsBalances: 'БАЛАНС',
   tsWithdrawal: 'Вывести',
   tsWhat: 'What is',
   tsTotalBalance: 'Общий баланс',
   tsInOrder: 'Замороженные',
   tsAvailableBalance: 'Доступные',
   tsWithdrawalAddress: 'Адрес вывода средств',
   tsUseNewAddress: 'Использовать новый адрес',
   tsInput: 'Please input your new withdrawal address below',
   tsAmount: 'Объём',
   tsWithdrawalLimit: '24h Withdrawal Limit',
   tsAvailable: 'Доступные',
   tsNoAvailable: 'Объём вывода превышает доступный объём',
   tsTransactionFee: 'Комиссия',
   tsReceiveAmount: 'Получено',
   tsSubmit: 'Представлене',
   tsHowWithdrawal: 'How to Withdrawal?',
   tsTips: 'ТЁПЛАЯ ПОДСКАЗКА',
   tsMinimum: 'Минимальная сумма для вывода',
   ...
   tsMoreThan: 'Объём вывода превышает доступный объём',
   ...
   txUseNewAddress: 'Использовать новый адрес',
