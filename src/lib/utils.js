...
export function getBrowserMessage() {
   ...
   else if (userAgent.indexOf("Safari") > -1 || userAgent.indexOf("safari") > -1) {
      browserType = 'safari'
   ...
   let browserObj = {
      ...
      browserVersion: browserVersion + '-' + browserType + '-' + window.navigator.platform,
      platform: window.navigator.platform,
      windowWith: window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth
   }
   return browserObj;
}