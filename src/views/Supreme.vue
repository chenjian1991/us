...
<br>
        ...
        <div class="row justify-content-md-between">
          ...
          <div class="col-md-5">
            <div class="mb-5">
              <h3 class="h4 text-white font-weight-normal">Supreme Swarovski Box Logo Hooded Sweatshirt</h3>
              ...
              <span class="d-block text-white mb-2">Tokens for Redemption：59800 Tokens/Hoodie</span>
              <span class="d-block text-white mb-2">ATO Token Price：$0.01</span>
              <span class="d-block text-white mb-2">Total ATO Sales Amount：598,000 Supreme Tokens</span>
