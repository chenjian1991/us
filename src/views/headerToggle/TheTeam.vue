  ...
  <div id="team" class="team">
    ...
    <main id="content" role="main">
      ...
      <div class="container space-2">
        <div class="row">
          <div class="col-lg-12">
            <p class="description">Founded in December of 2017 and based in the US, 55 TRADE is an asset network that provides user with access to a seamless and efficient flow of high-quality assets around the world. 55 TRADE is not limited to cryptocurrencies; we use blockchain technology and tokenization to bridge traditional markets to support the trading of a variety of assets.</p>
            <p class="description">Unlike  existing  networks,  55’s  funds  are  held  in  a  secured  3rd  party  trust,  (Prime  Trust,  NV),  not  in  a custody account typically utilized by other exchanges and brokers. We,  as  a  fiduciary,  have  additional  oversight  from  our  custodian  (PT)  to  ensure  and  verify  that  funds  are properly allocated and to prohibit the commingling of client and company funds. 55’s preferred stablecoin USD Digital (USDD) is 100% backed by USD managed by Prime Trust. Prime Trust confirms new funds have been received prior to minting of any new USDD.</p>
            <p class="description">Search for Career Opportunities with 55. <a target="_blank" class="text-primary" href="https://www.linkedin.com/company/55-global">Click for Career Opportunities with 55</a></p>              
          </div>
        </div>
      </div>
      <!-- End Content Section -->
      ...
      <div class="container space-bottom-2">
        ...
        <div class="w-md-80 w-lg-50 text-center mx-auto mb-9">
          <h2 class="text-primary-55" style="color: rgb(18, 134, 154); font-weight: 500;">Management Team</h2>
        </div>
        <!-- End Title -->
            ...
            <div class="js-slide px-3">
              ...
              <div class="row">
                  <div class="col-sm-6 d-sm-flex align-items-sm-start flex-sm-column text-center text-sm-left mb-7 mb-sm-0">
                    ...
                    <div class="d-inline-block">
                      <span class="badge badge-primary badge-pill badge-bigger mb-3" style="text-align:left">CCO & General Counsel</span>
                    </div>
