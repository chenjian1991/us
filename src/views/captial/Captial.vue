    ...
    <div class="d-lg-flex align-items-lg-center position-relative min-height-100vh--lg u-bg-img-hero u-space-3 u-space-5-top--md u-space-0--lg" style="background-image: url(assets/svg/bg/img32.jpg);">
      <div class="container mt-lg-5">
        <div class="w-lg-35 mb-5">
          <h1 class="display-4 text-white">55<strong class="font-weight-bold">Capital</strong> </h1>
          <p class=" text-white">We provide both capital and expertise to nourish </br> the infrastructure companies of the blockchain revolution.</p>
        </div>
      ...
      <div class="container position-absolute-bottom-0 u-space-2">
        <div class="js-slick-carousel u-slick"
          ...
          <div class="js-slide">
            <img class="u-clients ml-0" src="assets/svg/logos/captial-logo/Bankoin.png" alt="Image Description">
          </div>
          <div class="js-slide">
            <img class="u-clients ml-0" src="assets/svg/logos/captial-logo/Mercurity.png" alt="Image Description">
          </div>
          <div class="js-slide">
            <img class="u-clients ml-0" src="assets/svg/logos/captial-logo/Explus.png" alt="Image Description">
          </div>
          <div class="js-slide">
            <img class="u-clients ml-0" src="assets/svg/logos/captial-logo/DP.png" alt="Image Description">
          </div>
          <div class="js-slide">
            <img class="u-clients ml-0" src="assets/svg/logos/captial-logo/Daollar.png" alt="Image Description">
          </div>
        </div>
      </div>
      <!-- End Clients -->
        ...
        <div id="testimonialsNavMain" class="js-slick-carousel u-slick u-slick--transform-off mb-4"
          ...
          <div class="js-slide">
            ...
            <div class="w-md-80 w-lg-60 text-left mx-auto">
              <blockquote class="h6 mb-5">The 55 Capital team sees the transformative potential of blockchain and cryptocurrencies. The technology is evolving beyond the hype and is poised to deliver the anticipated cost savings, efficiencies, scale, and security that are leading to widespread adoption.

We believe in looking for opportunities throughout the world and in being prepared to take advantage of those opportunities.</br></br>

55 Capital focuses on meaningful equity investments in blockchain-based businesses and infrastructure. We provide both capital and expertise  to nourish the infrastructure companies of the blockchain revolution. Through our investment and support, we encourage portfolio companies to achieve the next level of success.</blockquote>
              <h4 class="h6 text-muted" style="text-align:center">David Weild, Co-chairman of 55, Former Vice Chairman of Nasdaq</h4>
            </div>
            <!-- End Testimonials -->
          </div>
        ...
        <div id="testimonialsNavPagination" class="js-slick-carousel u-slick u-slick--pagination-modern u-slick--transform-off mx-auto"
          ...
          <div class="js-slide">
            <img class="img-fluid u-avatar rounded-circle mx-auto" src="assets/img/100x100/1.png" alt="Image Description">
          </div>
...
<div class="container u-space-3">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-auto mb-9">
        ...
        <h2 class="text-primary">Why join<span class="font-weight-bold"> 55 Asset Network?</span></h2>
        </br>
        </br>
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0">
          <h3 class="h5">State-of-the-art trading tech</h3>

          <!-- List -->
          <ul class="list-unstyled text-secondary mb-0">
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              1 million TPS matching engine
            </li>
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
            ...
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Order book aggregation technology
            </li>
          </ul>
          <!-- End List -->
        </div>
        ...
        <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0">
          <h3 class="h5">Global asset access & liquidity</h3>

          <!-- List -->
          <ul class="list-unstyled text-secondary mb-0">
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Global Best Bid and Offering
            </li>
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Alliance for global exchanges
            </li>
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Asset tokenization utilities 
            </li>
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Asset Token Onboading Protocol 
            </li>
          </ul>
          <!-- End List -->
        </div>
        ...
        <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0">
          <h3 class="h5">Local compliance and marketing team</h3>

          <!-- List -->
          <ul class="list-unstyled text-secondary mb-0">
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Trading licenses in different jurisdictions
            </li>
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
             Local marketing team for your products
            </li>
            <li class="d-flex align-items-center py-2">
              <span class="mr-3">–</span>
              Local asset, worldwide exposure
            </li>
          </ul>
          <!-- End List -->
        </div>
