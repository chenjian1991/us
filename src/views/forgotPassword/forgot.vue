...
<script>
import {userVerify,verifyEmail,ipQuery,userStatus} from '../../../api/urls.js';
import {postBaseApi,postHeaderTokenBodyApi,getApiLoin,getApi} from '../../../api/axios.js';
import ModalTips from '@/components/Modal';
import {queryUserStatus,geeTest} from '../../../api/usersystem.js'
    ...
    export default {
        ...
        methods:{
            ...
            //         'callback':(data)=>{
            //              if(data.length!==0){
            //                 // this.requestGoogleFunEmail(data,'google')
            //                 let params = {
            //                         personType:'GOOGLE',
            //                         personCode:data,
            //                         loginName:this.formValidate.phoneNumber,
            ...
            //             this.onloadCallback();
            //         }else{
            //             this.ipCountry='中国'//ip查询失败的时候默认中国
            //         }
            //     }).catch((error)=>{//当ip获取失败都时候默认是中国
            //         this.ipCountry='中国'// 请求超时的还是把ip写死中国
            //     })
            // },
