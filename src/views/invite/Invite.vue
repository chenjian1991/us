         ...
         <ul class="content share_style">
            ...
            <li>
               ...
               <div class="share_content">
                  ...
                  <div class="invite_btn" v-clipboard:copy="userCode" v-clipboard:success="onCopy">
                     {{$t('yqzyCopyCode')}}
                  </div>
               </div>
            </li>
            <li>
               ...
               <div class="share_content">
                  ...
                  <div class="invite_btn" v-clipboard:copy="inviteLink" v-clipboard:success="onCopy">
                     {{$t('yqzyCopyLinkShare')}}
                  </div>
               </div>
            </li>
      ...
      methods: {
         ...
         usersCount() {//邀请总人数
            usersCount({userId: this.userId}, this.loginToken).then(res => {
               this.inviteUserCount = res.data.result
