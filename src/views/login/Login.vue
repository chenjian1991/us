<template>
  <div class="root">
        ...
        <div class="inner_input_login">
          ...
          <Form ref="formValidate" :model="formValidate" :rules="ruleValidate">
            <FormItem class="form_item" prop="phoneNumber">
              ...
              <Input
                class="isfocus_enter"
                v-model.trim="formValidate.phoneNumber"
                :placeholder="$t('siginAcountPlaceholder')"
              ></Input>
            </FormItem>
            <FormItem class="form_item" prop="password">
              ...
              <Input
                class="isfocus_enter"
                type="password"
                v-model.trim="formValidate.password"
            ...
            <Button
              v-if="loaded"
              class="loginbtn"
              @keydown.native.enter="handleSubmit('formValidate')"
    ...
    <Modal class="frozenModal" v-model="modal3" :closable="false" :mask-closable="false">
            ...
            function(res) {
              if (res) {
                let params = {
                  ...
                  password: _that.setSha(_that.formValidate.password),
                  personType: "GOOGLE",
                  personCode: res,
                  deviceType: "WEB",
      ...
      postBaseApi(login, {}, params)
        .then(res => {
          ...
          if (res.beforeToken) {
            ...
            if (this.fromSocial == "null" && this.fromSite == undefined) {
              //本站过来
              this.$router.push("/google");
            } else if (this.fromSite) {
              //跳回来源页面
              this.$router.push({
                path: "/google",
                query: {
            ...
            if (this.fromSocial == "null" && this.fromSite == undefined) {
              ...
              if (arr.indexOf(this.previousRouterName) !== -1) {
                //说明找到了
