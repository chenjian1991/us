                              ...
                              <TabPane v-for="(item, key,index) in siteItem" :key="index" :label="key" :name="key">
                                 ...
                                 <ul class="coinInfo">
                                    <li class="priceList" v-for="(v, key,index) in getFilterList(item)"
                                       ...
                                       <div class="priceItme">
                                          <Icon type="ios-star" color="#12869A" size="14" v-if="v.marked"
                                                @click.stop="addMarkCoin(v,key,false)"/>
                                          <Icon type="ios-star" color="#374853" size="14" v-else
                     ...
                     <div class="markBox" v-else>
                        ...
                        <ul class="coinInfo">
                           ...
                           <li v-else class="priceList" v-for="(v, key,index) in searchIn "
                               @click="changeBaseAssetList(v)" :key="key">
                              <div class="priceItme">
                                 <Icon type="ios-star" color="#12869A" size="14"
                                 ...
                                 <div class="trade-msg">
                                    <div class="price-box">
                                       ...
                                       <div class="input_container">
                                          <div class="inputbox">
                                             ...
                                             <div class="currencyInput"> ≈ {{buyPriceCurrency | scientificToNumber}}
                                                {{currencyName}}
                                             </div>
                                          </div>
                                          <div class="inputbox">
                                             <input @input="handleBuyCountInput" type="text" maxlength="14"
                                                    ref="buyCountInputRef" :class="{'input-empty-color':buyCountEmpty}"
                                    ...
                                    <div class="range">
                                       ...
                                       <div class="range-ball" data-side="buy" :data="buyBallTotal"
                                          ...
                                          <div class="ball" style="left: 25%;transform: translateX(-25%);"
                                               data-num="0.25">
                                             <div  v-if="buyBallPercentage == '0.25'" class="active-ball"></div>
                                          </div>
                                          <div class="ball" style="left: 50%;transform: translateX(-50%);"
                                               data-num="0.5">
                                             <div  v-if="buyBallPercentage == '0.5'" class="active-ball"></div>
                                          </div>
                                          <div class="ball" style="left: 75%;transform: translateX(-75%);"
                                               data-num="0.75">
                                             <div  v-if="buyBallPercentage == '0.75'" class="active-ball"></div>
                                          </div>
                                          <div class="ball" style="left: 100%;transform: translateX(-100%);"
                                               data-num="1">
                                 ...
                                 <div class="trade-msg">
                                    <div class="price-box">
                                       ...
                                       <div class="input_container">
                                          <div class="inputbox">
                                             ...
                                             />
                                             <div class="name-show quoteAsset">{{currentInfo.quoteAsset}}</div>
                                             <div class="currencyInput"> ≈ {{sellPriceCurrency | scientificToNumber}}
                                                {{currencyName}}
                                             </div>
                                          </div>
                                          <div class="inputbox">
                                    ...
                                    <div class="range ">
                                       ...
                                       <div class="range-ball" data-side="sell" :data="sellBallTotal"
                                            @click="changeSailBall">
                                          <div class="ball sell-ball" style="left: 0;transform: translateX(0);"
                                               data-num="0">
                                             <div  v-if="sellBallPercentage == '0'" class="active-sellball"></div>
                                          </div>
                                          <div class="ball sell-ball" style="left: 25%;transform: translateX(-25%);"
                                               data-num="0.25">
                                             <div  v-if="sellBallPercentage == '0.25'" class="active-sellball"></div>
                                          </div>
                                          <div class="ball sell-ball" style="left: 50%;transform: translateX(-50%);"
                                               data-num="0.5">
                                             <div  v-if="sellBallPercentage == '0.5'" class="active-sellball"></div>
                                          </div>
                                          <div class="ball sell-ball" style="left: 75%;transform: translateX(-75%);"
                                               data-num="0.75">
                                             <div  v-if="sellBallPercentage == '0.75'" class="active-sellball"></div>
                                          </div>
                                          <div class="ball sell-ball" style="left: 100%;transform: translateX(-100%);"
                                               data-num="1">
                                    ...
                                    <button class="mybtn sell-btn" :disabled="sellDisabled" @click="sellBtn" v-else><em>{{$t("bbjySellOperation")}}</em>
                                    </button>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="trade-history">
                        <div class="history-content">
                           <div class="history_row" v-for="(v,i) in tradeHistoryArr" @click="getClickPrice(v.price)"
                                :key="i">
                              <div :class="[v.showColor == -1?'redText':'',v.showColor == 1?'greenText':'','pointer']">
                                 {{v.price}}
                              </div>
