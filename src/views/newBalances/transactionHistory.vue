        ...
        identifyQuery({
          ...
          if (res.data.length) {
            ...
            if (identifyState === 'SUCCESS') {
              console.log(formJson.firstName,formJson['middleName'] )
              this.information[0].value = this.bankAccountName = `${formJson.firstName}${formJson['middleName'] ? formJson['middleName'] : ' '}${formJson.lastName}`
