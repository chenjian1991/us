    ...
    <main class="home" id="home">
        ...
        <div class="top pb-5">
            <div class="container">
                ...
                <section class="c-C7D1D9 f-18 mt-1 top-desc pt-6 pt-lg-0">
                    Tresso’s institutional-grade GBBO™ technology scans deep liquidity pools across the globe to deliver
                    the best
                    prices available from its network of partner nodes. Coupled with high-speed cross-fiat conversion, a
                    seamless
                    single point of execution and no additional fees for <a
                        href="https://tresso.zendesk.com/hc/en-us/articles/360038973474-What-is-USD-Digital-USDD-"
                        target="_blank"
                    ...
                    <div class="quote">
                        ...
                        <div class="t-l">
                            <Tooltip placement="top"
                                ...
                                <img src="../../assets/images/tresso/tishi.svg" alt="" width="15"
        ...
        <div class="gbbo-mobile gbboMobile" id="GBBO">
            ...
            <Row class="mobile-quote-list">
                <Col span="2" class="t-c">
                    <img src="../../assets/images/tresso/mobile-down.png" alt="" class="img" v-show="turn"
                         @click="toggle">
                    <img src="../../assets/images/tresso/mobile-right.png" alt="" class="img" v-show="!turn"
                         @click="toggle">
                </Col>
        ...
        <div class="gbboTM-box pt-11 pb-11 bgc-12191F">
            <div class="container p-3">
                ...
                <p class="f-16 f-w-5 c-B9C9D6 mt-6 t-c">Tresso’s proprietary technology, GBBO™, provides access* to many
                    of the
                    deepest global liquidity pools and enables superior trade execution. <br>This power is not currently
                    available
        ...
        <div class="free-box bgc-fff t-c pt-11 pb-11">
            <div class="container p-3">
                ...
                <p class="f-14 c-77838F t-l mt-4">**Using smart order routing and matching engine technology, GBBO
                    discovers the
                    ...
                    <div v-bind:class="i===0?'pr-lg-8':i===1?'pl-lg-5':'pl-lg-9'">
                        ...
                        <Tooltip placement="top-end" offset="13" v-if="i===2">
                            <section slot="content" class="f-w-4 c-FEFFFF">
                                Tresso offers no fee trading for USDD pairs. The displayed price may include fees
                                charged by our service
                                providers
                                and/or market makers. <br>
                                The fee structure for USD pairs can be found
                                <router-link to='/usd_fees' class="here">here</router-link>
                            </section>
                            <img src="../../assets/images/tresso/help.png" alt="" width="16" style="vertical-align: sub"
                                 class="ml-2">
                        </Tooltip>
                    ...
                    <div class="col-md-7 manager-right">
                        ...
                        <div class="pl-3 pr-3">
                            ...
                            <section class="f-16 c-77838F f-w-5">
                                Given the maturation of the crypto, token, and digital asset markets, the trading
                                standards and operations found in current exchanges are woefully underdeveloped when
                                compared with those of traditional markets. Tresso’s institutional-grade trading with
                                Global Best Bid and Offer is a necessary innovation to these nontraditional markets. The
                                Global Best Bid and Offer is the first of many innovations that we expect to bring to
                                this marketplace to enhance institutional trust, credence and participation in
        ...
        <div class="trading-box bgc-fff pt-11 pb-11 t-c">
            <div class="container pt-4 pb-4">
                ...
                <p class="f-18 c-d-gray mt-3">Tresso is currently in closed beta. Sign up now to be first on the
                    list.</p>
                <router-link :to="'/optionalRegistration'"
