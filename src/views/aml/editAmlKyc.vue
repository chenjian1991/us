<template>
    <div id="editamlkyc" class="root">
                         ...
                         <div class="clearfix date_picker">
                          ...
                          <div  class="clearfix">
                                ...
                                <FormItem class="form_item pull-left" prop='email'>
                                    <Input :maxlength="50" type="text" v-model="formValidate.email" placeholder="please input your email"></Input>
                                </FormItem>
                        </div>
                         <div class="clearfix">
                                <div class="pull-left span-label">
                               ...
                               <FormItem class="form_item phone_item pull-left" prop='phoneNumber'>
                                    ...
                                    <Input  type="text"  :maxlength="15" v-model="formValidate.phoneNumber"  :placeholder="$t('phonePlacehodlerphone')"></Input>
                                </FormItem>
                         </div>
                         </section>
                            ...
                            <div  class="clearfix">
                             ...
                             <div v-if="Rigionflag"  class="clearfix">
                              ...
                              <div  class="Address_certificate">
                                ...
                                <span v-if="alreadyUpload" style="position:relative;top:16px;left:20px;" v-html="uploadName"></span>
                             </div>
                        ...
                        <section class="section_Tax">
                                 ...
                                 <div v-if="taxidFlag" class="clearfix">
                                    ...
                                    <FormItem class="form_item pull-left" prop='PassportNumber'>
                                        <Input :maxlength="9" type="text" v-model="formValidate.PassportNumber" placeholder=""></Input>
                                    </FormItem>
                                </div>
                                 <div v-else  class="clearfix">
                                    ...
                                    <FormItem class="form_item pull-left" prop='TaxId'>
                                        <Input :maxlength="9" type="text" v-model="formValidate.TaxId" placeholder=""></Input>
                                    </FormItem>
                                </div>
                        </section>
                        ...
                        <section class="section_infomation">
                            ...
                            <div v-else  class="clearfix">
                             ...
                             <div class="clearfix date_picker">
                                ...
                                <FormItem class="form_item pull-left radio" prop='expiredDate'>
                                    <Row>
                                        <Col span="12">
                                            <DatePicker :options='optionsExpired'  v-model="formValidate.expiredDate"  @on-change='expireDate' type="date" placeholder="Select date" style="width: 200px"></DatePicker>
                                        </Col>
                                    </Row>
                                </FormItem>
                            </div>
        ...
        <Modal
                ...
                <p slot="footer">
                <Button @click="completeID">complete L1 Verification</Button>
                </p>
            </Modal>
        ...
        methods:{
            handleSubmit (name) {
             ...
             L2queryState(token){
                getHeaderTokenApi(amlqueryInfo,'',token).then((res)=>{
                    if(res.data){
                        let result = res.data;
                        this.formValidate.firstName = result.firstName;
                        this.formValidate.lastName = result.lastName;
                        //this.passportType = result.proofType;//类型
                        this.gender = result.tpGender;
                        this.formValidate.date_time = moment(result.birthday).format('YYYY-MM-DD');
                        this.dateBirthday  = result.birthday;
                        this.formValidate.email = result.tpEmail;
                        this.formValidate.phoneNumber = result.tpPhone;
                        this.Address = result.addressType;
                        this.countryresidenceName = result.tpCountry;//  给后台传的国家简称
                        this.countryNumberResidence = result.tpCountry;
                        this.countryNumberTaxation = result.taxCountry;
                        this.taxcountryName = result.taxCountry;//  后台给的国家简称
                        this.formValidate.PassportNumber = result.passport;
                        this.formValidate.TaxId = result.passport;
                        this.formValidate.Street = result.tpStreet;
                        this.formValidate.City = result.tpCity;
                        this.formValidate.Rigion = result.usRegion;
                        this.uploadName = result.addressCertificate;
                        this.passportType = result.identifyType;
                        this.formValidate.IDNumber = result.identifyId;
                        this.formValidate.PassportTwo  = result.identifyId;
                        this.formValidate.expiredDate  = moment(result.identifyExpire).format('YYYY-MM-DD');
                        this.alreadyUpload = true;
                        this.expireIdDate = result.identifyExpire;
                        this.formValidate.Postalcode = result.usPostalcode;
                        this.formValidate.Rigion  = result.usRegion;
                        this.countryNumber = result.tpItc;
                        if(this.countryresidenceName=='US'){
                             this.Rigionflag = true;
                        }else{
                             this.Rigionflag = false;
                        }
                        if(this.taxcountryName=='US'){
                                this.taxidFlag = false;
                                this.passportortax = this.formValidate.TaxId;
                        }else{
                                this.taxidFlag = true;
                                this.passportortax = this.formValidate.PassportNumber;
         ...
         sumbitL2verify(token){
             ...
             let params = {
                    ...
                    "tpCountry": this.tpCountryresdence?this.tpCountryresdence:this.countryresidenceName, //
                    ...
                    "addressCertificate": this.imgFilePath?this.imgFilePath:this.uploadName,
                    "taxCountry":this.taxCountry?this.taxCountry:this.taxcountryName,
                    "passport":this.selfSelectPassportorTaxid,
                    "identifyType": this.passportType,
                    "identifyId": this.formValidate.IDNumber==''||this.formValidate.IDNumber==undefined ? this.formValidate.PassportTwo:this.formValidate.IDNumber,
