            ...
            <ul class="right">
               ...
               <li>
                  <span class="nav-icon">
                     ...
                     <a href="https://t.me/English_55GlobalMarkets" class="links"><Icon type="ios-paper-plane"/></a>
            ...
            <ul class="left">
               ...
               <li class="tradecenter">
                  ...
                  <ul class="tradeList">
                     ...
                     <li>
                        <router-link :to="{path:'/exchange',query: {site: 'C'}}"><i class="icon logoIcon"></i> <span>{{$t('headercustomerexchange')}}</span>
                        </router-link>
                     </li> 
                  </ul>
               </li>
   ...
   export default {
      data() {
         return {
            ...
            short: '$',
            languageToCurrency:[
               {language:'en',value:'USD'},
               {language:'zh-CN',value:'CNY'},
               {language:'zh',value:'CNY'},
               // {language:'ko',value:'KRW'},
               // {language:'vi',value:'USD'},//  越南盾
               // {language:'ru-ru',value:'RUB'},// 俄语 卢比
               // {language:'de-de',value:'EUR'}, //德语 欧元
               // {language:'fr-fr',value:'EUR'}, //法语 欧元
               // {language:'es-es',value:'EUR'}, //西班牙 欧元
               // {language:'tr-tr',value:'TRY'}, //土耳其语 欧元
               // {language:'pt-br',value:'EUR'}, //葡萄牙 
               // {language:'pt-pt',value:'EUR'}, // 葡萄牙  
               // {language:'th-th',value:'THB'}, // 泰国 
               // {language:'id',value:'IDR'}, //印度尼西亚
            ]
         }
      },
      methods: {
