            ...
            <div v-bind:style="styleObject" class="footer-inner">
                <div class="service-contain clearfix">
                    <div class="service">
                        ...
                        <p class="email">service@</p>
                    </div>
                    <div class="email-btn">
                        <a style="color:#fff;" href="mailto:service@tresso.com">
                ...
                <div class="company clearfix">
                    <ul>
                        ...
                        <li><a target="_blank" href="https://t.me/English_55GlobalMarkets">Telegram</a></li>
                        <li><a target="_blank" href="https://www.facebook.com/55AssetNetwork">Facebook</a></li>
                        <li><a target="_blank" href="https://twitter.com/55AssetNetwork">Twitter</a></li>
                    </ul>
                </div>
